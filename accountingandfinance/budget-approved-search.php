...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="/IT3AHCTS/A&FD/A&FD/accountingandfinance/icons/logo.png">
  <title>Admin | Accounting and Finance Department</title>
  <link rel="stylesheet" href="/IT3AHCTS/A&FD/A&FD/accountingandfinance/css/budget-approved.css">
</head>
<body>
  ...
  <div id="forapprovalContainer">
      ...
      <div id="forapprovalContent">
          <table id="forapprovalTable" align="center">
              ...
              <tbody>
                  <?php
                    $query = mysqli_query($con, "SELECT * FROM af_requestbudget WHERE requeststatus='APPROVED' AND requestname LIKE '%".$search."%'");
