...
var clossmodal = document.getElementById("exitIcon");
...
clossmodal.addEventListener("click", hideModal);
...
function hideModal(){
    document.getElementById("modalviewContainer").style.display = "none";
}