...
<head>
  ...
  <link rel="stylesheet" href="/IT3AHCTS/A&FD/accountingandfinance/css/loan-disapproved.css">
</head>
<body>
  ...
  <div id="forapprovalContainer">
      <div id="styleForm">
        <div id="textForm" class="inline-Cont">Disapproved Loans</div>
        <div id="noteForm" class="inline-Cont"><form action="loan-disapproved-search.php" method="post" id="form-search" class="inline-Cont">
      ...
      <div id="forapprovalContent">
          <table id="forapprovalTable" align="center">
              ...
              <tbody>
                  <?php
                    $query = mysqli_query($con, "SELECT * FROM af_loan WHERE requeststatus='DISAPPROVED' AND requestname LIKE '%".$search."%'");
  ...
  ?>
  <script src="/IT3AHCTS/A&FD/accountingandfinance/js/loan-disapproved.js"></script>
</body>
</html>
<?php
    }
