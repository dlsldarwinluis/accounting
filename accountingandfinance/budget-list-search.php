...
<head>
  ...
  <link rel="stylesheet" href="/IT3AHCTS/A&FD/accountingandfinance/css/budget-list.css">
</head>
<body>
  ...
  <div id="forapprovalContainer">
      <div id="styleForm">
        <div id="textForm" class="inline-Cont">Budget Requests</div>
        <div id="noteForm" class="inline-Cont"><form action="budget-list-search.php" method="post" id="form-search" class="inline-Cont">
      ...
      <div id="forapprovalContent">
          <table id="forapprovalTable" align="center">
              ...
              <tbody>
                  <?php
                    $query = mysqli_query($con, "SELECT * FROM af_requestbudget WHERE requeststatus='' AND requestname LIKE '%".$search."%'");
 ...
 <?php
    if(isset($_POST["submitApprove"])){
        ...
        $sqlselect = mysqli_query($con, "SELECT * FROM af_requestbudget WHERE requestid='$id'");

        while($rowtwo = mysqli_fetch_assoc($sqlselect)){
            $amount = $rowtwo['requestamount'];
            ...
            while($data = mysqli_fetch_assoc($fund)){
                ...
                if($fundAmount > $amount){
                    ...
                    mysqli_query($con, "UPDATE af_requestbudget 
  ...
  ?>
  <script src="/IT3AHCTS/A&FD/accountingandfinance/js/budget-list.js"></script>
</body>
</html>
<?php
    }
