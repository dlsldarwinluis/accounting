<?php
    ...
    if(!isset($_SESSION["session_accountname"]) && !isset($_SESSION["session_id"])){
        ...
        if(isset($_POST['inputsubmit'])){
            ...
            mysqli_query($con,"INSERT INTO af_requestbudget (requestname, requestdepartment, requestposition, requestemail, requestamount, requestreason) VALUES ('$reqname', '$reqdepartment', '$reqposition', '$reqemail', '$reqamount', '$reqreason')");
            ?>
            <script>
                alert("Your request is successfully submitted! Please check your request history regularly for the approval/disapproval notice of the request!");
                location.reload();
...
<head>
  ...
  <link rel="stylesheet" href="/IT3AHCTS/A&FD/request-budget/css/request-budget.css">
</head>
<body>
  ...
  <div id="formContainer">
    <div id="styleForm">
        <div id="textForm">Request Budget</div>
        <div id="noteForm">Note: Please answer the following details</div>
    </div>
    <div id="formContent">
        <form action="" method="post" id="form-budgetrequest" class="form-accountingandfinance">
