...
$pdf->Cell(0, 12, 'Loan Request Transaction', 0, 1, 'L');
...
$result = mysqli_query($con, "SELECT * FROM loanaf WHERE requestid='$id' AND requeststatus='APPROVED'");
...
$pdf->Output('loantransaction.pdf', 'I');
